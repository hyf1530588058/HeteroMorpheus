...
def run_mybody(experiment_name, structure_shape, max_evaluations, train_iters, num_cores):   
    print()
    ...
    while True:
        ...
        for structure in structures:           
            ...
            group.add_job(run_mybodyppo11, ppo_args, callback=structure.set_reward)   
