...
def run_universal4(experiment_name, structure_shape, max_evaluations, train_iters, num_cores):   
    print()
    ...
    # actor_critic.load_state_dict(torch.load(os.path.join(root_dir,"saved_data", "76", "controller","robot_"+str(21)+ "_controller" + ".pt"))[0].state_dict())
    ...
    while True:
        ...
        for structure in structures:           
            ...
            group.add_job(run_ppo4, ppo_args, callback=structure.set_reward)  
